        ...
        <>
            <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
                ...
                <div className="max-w-xl z-10 text-gray-500">
                    ...
                    <p className="text-sm">
                        Course by <span className="text-blue-600 underline">Umbra obi</span>
                    </p>
                        ...
                        <div className="pt-5">
                            {courseData.courseContent.map((chapter, index) => (
                                ...
                                >
                                    ...
                                    <div
                                        className={`overflow-hidden transition-al duration-300 ${openSections[index] ? "max-h-96" : "max-h-0"
                                            }`}
                                    >
                                        <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300">
                                            {chapter.chapterContent.map((lecture, i) => (
                                                <li key={i} className="flex items-start gap-2 py-1">
                                                    ...
                                                    />
                                                    <div className="flex items-center justify-between w-full text-gary-800 text-xs md:text-default">
                                                        <p>{lecture.lectureTitle}</p>
                                                        <div className="flex gap-2">
                                                            {lecture.isPreviewFree && (
                                                                <p onClick={() => setPlayeData({
                ...
                <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
                    ...
                    <div className="p-5">
                        ...
                        <div className="flex gap-3 items-cnter pt-2">
                        ...
                        <div className="pt-6">
                            <p className="md:text-xl text-lg font-medium text-gray-800">
                                ...
                                <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                                    ...
                                    <li>
                                        Quizzez to test your knowledge
                                    </li>
                                    <li>
